...
/****************************内容ID数据********************/
#define UI_Data_ID_Del   		0x0100 	//客户端删除图形
#define UI_Data_ID_Draw1 		0x0101	//客户端绘制一个图形
#define UI_Data_ID_Draw2 		0x0102
#define UI_Data_ID_Draw5 		0x0103
#define UI_Data_ID_Draw7 		0x0104
#define UI_Data_ID_DrawChar 0x0110//客户端绘制字符图形
/****************************红方机器人ID********************/
...
#define UI_Data_RobotID_RRadar 9//雷达
/****************************蓝方机器人ID********************/
...
#define UI_Data_CilentID_RAerial 0x0106//空中操作手
/***************************蓝方操作手ID***********************/
...
typedef uint8_t    u8;                 /*!< Offset: 0x000 ( /W)  ITM Stimulus Port 8-bit */
typedef uint16_t   u16;                /*!< Offset: 0x000 ( /W)  ITM Stimulus Port 16-bit */
